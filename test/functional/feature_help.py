...
"""Verify that starting smartcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start smartcoin with -h for help text")
        ...
        self.log.info("Start smartcoin with -version for version information")
