...
<context>
    ...
    <message>
        <source>A message that was attached to the litecoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Smartcoin network.</source>
        <translation>Một tin nhắn được đính kèm với số litecoin: URI mà sẽ được lưu giữ với transaction dành cho tài liệu tham khảo. Lưu ý: Tin nhắn này sẽ không được gửi thông qua Smartcoin network.</translation>
    </message>
    <message>
        <source>Pay To:</source>
