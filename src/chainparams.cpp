...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.smartcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.smartcointools.com");
        vSeeds.emplace_back("dnsseed.smartcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.smartcointools.com");
        vSeeds.emplace_back("seed-b.smartcoin.loshan.co.uk");
