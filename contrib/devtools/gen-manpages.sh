...
LITECOIND=${LITECOIND:-$SRCDIR/smartcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/smartcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/smartcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/smartcoin-qt}
