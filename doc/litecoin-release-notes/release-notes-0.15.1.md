Smartcoin Core version *0.15.1* is now available from:

  <https://download.smartcoin.org/smartcoin-0.15.1/>
...
A number of changes to the way Smartcoin Core deals with peer connections and invalid blocks
